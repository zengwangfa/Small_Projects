...
//1,增加了对UCOSII的支持
////////////////////////////////////////////////////////////////////////////////// 	  
u8 recv_buffer[127]={0}; //串口1接收数据缓冲变量,
u16 send_buffer[(MAX_DATA_LENS)]; //串口1发送数据缓冲变量,
u8 recv1_data_p=0;              //串口1接收数据指针
...
void USART1_IRQHandler(void)                             	 //串口1中断服务程序
{
	...
	{
		recv_buffer[Res] = USART_ReceiveData(USART1);	 //读取串口1接收到的数据
		Res++;
